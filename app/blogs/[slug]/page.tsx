      ...
      <div className="bg-gradient-hero shadow-sm border-b pt-20">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto animate-fade-in-up">
            <Link href="/blogs" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 transition-colors mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {Object.values(blogPosts)
                ...
                .slice(0, 2)
                .map((relatedPost) => (
                  <Link key={relatedPost.id} href={`/blogs/${Object.keys(blogPosts).find(key => (blogPosts as any)[key].id === relatedPost.id)}`}>
